  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Впервые за годы я по-настоящему выспалась. Wabi Hotel — это не просто ночлег, это перезагрузка. Я вернусь сюда снова — и уже скоро.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Екатерина Волкова</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Гостья сьюта «Ваби», Москва</p>
        </div>
      </div>
    </section>
  )
