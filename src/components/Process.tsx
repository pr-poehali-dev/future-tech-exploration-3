...
const steps = [
  {
    ...
    title: "Бронирование",
    description:
      "Выбираете номер и даты — мы подтверждаем в течение часа. Никаких предоплат вперёд: оплата при заезде или онлайн по вашему желанию.",
  },
  {
    number: "02",
    title: "Заезд",
    description:
      "Встречаем вас с чаем матча и рассказываем о ритуалах отеля. Check-in в любое время — ключ ждёт вас, даже если приедете поздно.",
  },
  {
    number: "03",
    title: "Пребывание",
    description:
      "Завтрак в номер, spa по расписанию, прогулки по саду. Мы рядом — но не навязчиво. Вы задаёте ритм своего отдыха.",
  },
  {
    number: "04",
    title: "Возвращение",
    description:
      "Гости Wabi возвращаются снова. Для постоянных гостей — персональные предпочтения сохраняются, а номер готовится заранее.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Ваш
                <span className="italic"> идеальный</span> отдых
              </h2>
              <p
              ...
              >
                От первого сообщения до тёплого чая в номере — каждый шаг продуман так, чтобы вы расслабились ещё до заезда.
              </p>
            </div>
          </div>
