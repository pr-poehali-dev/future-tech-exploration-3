  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Отдых,
          <span className="block text-sage">который восстанавливает</span>
        </h1>
        ...
        >
          Бутик-отель в стиле Japandi — там, где японский покой встречается со скандинавским уютом. Номера, где тишина стала главным сервисом.
        </p>
